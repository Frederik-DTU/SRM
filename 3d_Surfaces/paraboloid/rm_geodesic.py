...
def parse_args():
    ...
    # File-paths
    parser.add_argument('--data_path', default='Data/parabolic.csv', 
                        type=str)
    ...
    parser.add_argument('--load_model_path', default='trained_models/main/parabolic_epoch_100000.pt',
                        type=str)
...
def main():
    ...
    x = (torch.tensor(paraboloid_fun(zx[0],zx[1]))).float()
    y = (torch.tensor(paraboloid_fun(zy[0],zy[1]))).float()
