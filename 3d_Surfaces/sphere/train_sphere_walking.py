...
def parse_args():
    ...
    # File-paths
    parser.add_argument('--data_name', default='sphere_walking', 
                        type=str)
...
def main():
    ...
    #paths
    data_path = 'Data/'+args.data_name+'.mat'
    ...
    DATA = torch.Tensor(DATA).to(args.device) #DATA = torch.Tensor(df.values)
