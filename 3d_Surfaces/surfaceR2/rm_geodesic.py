...
def parse_args():
    ...
    # File-paths
    parser.add_argument('--data_path', default='Data/surface_R2.csv', 
                        type=str)
    ...
    parser.add_argument('--load_model_path', default='trained_models/main/surface_R2_epoch_100000.pt',
                        type=str)
...
def main():
    ...
    x = (torch.tensor(R2_fun(zx[0],zx[1]))).float()
    y = (torch.tensor(R2_fun(zy[0],zy[1]))).float()
